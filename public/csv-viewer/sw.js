...
const RUNTIME_CACHE = 'csv-viewer-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/csv-viewer/',
  '/csv-viewer/manifest.json',
  '/csv-viewer/icon-192.png',
  '/csv-viewer/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/csv-viewer/manifest.json';
}
