...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/csv-viewer/sw.js, scope=/csv-viewer/）。
    // scope がツールの全 locale ページ（/csv-viewer/, /csv-viewer/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/csv-viewer/sw.js', {
      scope: '/csv-viewer/',
    });
