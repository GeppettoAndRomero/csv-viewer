...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Scope to genuinely unit-testable pure modules. The island (CsvViewer)
      // and SW registration are DOM/integration-heavy and covered by the
      // Playwright e2e suite instead. csvParse.parseDelimited lazy-loads
      // papaparse and is exercised end-to-end + in the parse unit test.
      include: [
        'src/utils/fileValidation.ts',
        'src/utils/settings.ts',
        'src/utils/settingsStorage.ts',
        'src/utils/csvParse.ts',
